...
public class MemberService {
    ...
    public void signupMember(int memNo, String id, String pwd, int age, String[] hobbies, BloodType bloodType) {
        Member signupMember = mr.signupMember(memNo,id,pwd,age,hobbies,bloodType);
