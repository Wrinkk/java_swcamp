...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /* 설명. 내부 인터페이스인 Sum의 하위 구현체에서 존재하는 메소드를 오버라이딩(feat.람다식 활용)*/
        /* 설명. 람다식을 활용해 함수를 별도로 변수에 담는 느낌으로 작성한 코드 */
        ...
        System.out.println("20과 10의 곱: " + multi.multilplyTwoNumber(20, 10));
