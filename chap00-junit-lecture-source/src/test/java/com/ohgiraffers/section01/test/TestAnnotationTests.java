...
/* 필기. 테스트 클래스들은 크래스명 끝에 'Tests'를 붙여 작명한다. */
public class TestAnnotationTests {

    /* 수업목표. Junit5의 기본 애노테이션을 사용할 수 있다. */
    /* 필기.
    ...
    * */
    ...
    /* 설명.
     *  @Test는 기본적인 테스트 메소드를 만들기 위해 사용하는 애노테이션이다.
    ...
    * */
    ...
    public void 매개변수로_1과_3을_넘겼을_때_합계를_잘_반환하는지_확인() {
