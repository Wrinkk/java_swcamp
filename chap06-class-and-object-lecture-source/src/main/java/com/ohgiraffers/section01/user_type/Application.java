...
public class Application {
    ...
    * */
    public static void main(String[] args) {
        ...
        /* 설명.
         *   회원 정보를 관리하기 위해 회원의 여러정보(아이디, 비밀번호, 이름, 나이,
         *   성별, 취미를 취급하여 관리 하려고한다.
        ...
        * */
        ...
        /* 설명. 회원 정보를 하나의 전달인자로 전달하고 하나의 매개변수를 받을 수 있다. */
    ...
    private static Member printMember(Member member) {
        System.out.println("개명을 시작을 합니다.");
        member.name = "박길동";
