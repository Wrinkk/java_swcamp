...
public class User {
    ...
    public User(String id, String pwd, String name, Date enrollDate) {
        /* 필기. 생성자 안의 this.는 해당 생성자를 통해 생성될 객체에 접근하는 것 */
...
//        this(id, pwd, name); // 다른 생성자를 활용하는 구문(this())는 반드시 먼저 명시 되어야 한다. (시험문제?..)

        System.out.println("모드 필드를 초기화하는 매개변수 있는 생성자를 통해 User 객체 생성 됩니다.");
    }
