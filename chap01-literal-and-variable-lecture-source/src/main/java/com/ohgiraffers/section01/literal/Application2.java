...
public class Application2 {
    public static void main(String[] args) {
        ...
        /* 필기. 정수와 실수의 연산 결과는 실수가 나온다.(정수를 실수로 바꿔 연산 해준다.) */
...
//        System.out.println("hello" % "world");
        ...
        /* 설명. 이항연산자들의 묶음에서 좌축에서부터 이항씩 연산하면 아래 코드의 결과를 이해할 수 있다. */
        System.out.println(123 + 3 + "helloworld" + 123 + 3);       // 126helloworld1233 출력

        /* 설명. 문자열 뒤에 숫자를 활용한 연산을 쓰게 되면 소괄호(())를 써서 우선순위를 높이고 연산해주어야 함. */
