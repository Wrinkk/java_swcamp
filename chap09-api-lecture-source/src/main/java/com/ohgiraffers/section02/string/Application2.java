...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        String str1 = "java"; //리터럴형태의 초기화
        String str2 = "java";
        String str3 = new String("java"); //각각 새로운 객체이기에 참조값이 다름
        ...
        /* 필기.
         *  String 객체는 리터럴로 생성 될 때는 heap 영역의 상수풀(constant pool)에 생성된다.
         *  상수들은 동등한 String 객체를 하나만 저장하는 (중복 제거) 공간으로 동일한 String 변수를
         *  효율적으로 사용할 수 있도록 제공된다.(String의 equals()와 hashCode()를 통해 적용)
         *
        * */

        /* 설명. 위의 네가지 경우 모두 동등한 String 객체 이므로 equals는 true, hashCode는 같은 값이 나온다. */
