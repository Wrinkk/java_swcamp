...
public class Application1 {
    public static void main(String[] args) {
        ...
        System.out.println("long 타입 시간을 활용한 Date: " + new Date(today.getTime()));
        System.out.println("기준시간(1970년 0시 0분 0초): " + new Date(0L));
...
//        java.sql.Date sqlDate2  = (java.sql.Date)today;               // 실제로는 sql.Date형 이었던 날짜형을 util.Date형인 today에 담겨 있었다면 이 방법도 가능하다.
