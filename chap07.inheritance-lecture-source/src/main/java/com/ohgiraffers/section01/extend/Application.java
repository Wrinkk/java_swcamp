...
public class Application {
    public static void main(String[] args) {
         ...
         *  하지만 다순히 물려받아 재사용하는 개념보다 부모클래스의 개념을 확장(extends)하는데 더 의의가 있으며
         *  현재 가장 중요한 의미를 다형성을 적용하기위한 문법적 토대가 된다는 사실이다.
         *
         *  필기.
         *   상속의 이점
         ...
         *  필기.
         *   상속의 단점
         *   1. 부모 클래스의 기능을 추가/변경할 시 자식 클래스가 정상적으로 작동하게 될지 예측하기 힘들다.
         ...
         *    이후 다형성을 적용하면 자식의 오버라이딩 된 메소드가 동작하게 된다.(동적 바인딩)
         *
         *  필기.
         *   장점과 단점을 고려했을 떄, 상속은 오용의 가능성이 있기 때문에 IS-A 관계로 구분되는 경우에만 잘 고려하여
         *   적용해야 한다.
         *   (IS-A 관계 VS HAS-A 관계)
        * */
