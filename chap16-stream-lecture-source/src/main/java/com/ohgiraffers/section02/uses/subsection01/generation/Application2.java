...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        intStream.forEach(value -> System.out.println(value + " ")); // 람다식 오버라이딩 (무엇인가 추가적으로 적을때)
//        intStream.forEach(System.out::println); <- consumer 타입
        System.out.println();
        ...
        * */
        Stream<Double> doubleStream = new Random().doubles(5).boxed(); //boxed를 적으면 <> 제네릭됨.
        doubleStream.forEach(value -> System.out.println(value + " "));
        System.out.println();

        /* 설명. 문자열을 split하여 stream으로 생성 */ // Pattern.compile 구분자
        Stream<String> splitStream = Pattern.compile(",").splitAsStream("html,css,javascipt");
